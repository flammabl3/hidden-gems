// packages : npm expo install , npm install react-native-maps , npm install expo-linear-gradient , npm install expo-router, npm install expo-location, npm install @supabase/supabase-js, npx expo install @react-native-picker/picker, npm install i18next react-i18next expo-localization
/* todo: 
